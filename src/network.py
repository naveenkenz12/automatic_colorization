...
class Network:
    ...
    def create_net(self,data_i):
		...
		pool1 = maxpool2d('mp_1',conv2,[2, 2], strides=2)
		...
		pool2 = maxpool2d('mp_2',conv4,[2, 2], strides=2)
		...
		pool3 = maxpool2d('mp_3', conv7,[2, 2], strides=2)
		...
		conv13 = deconv2d('deconv3',conv13,[3,3,128,128],stride=2,wd=self.weight_decay)
		conv11 = deconv2d('deconv4',conv11,[3,3,256,256],stride=4,wd=self.weight_decay)
		#will go to concat layer (112*112*128)
		#conv2 = (224,224,64)
		#conv13 = (224,224,128)
		#conv11 = (224,224,256)
		concat = tf.concat([conv2,conv11,conv12,conv13],-1)
		conv14 = conv2d('conv14' , concat, [3,3,448,256], stride=1,wd=self.weight_decay)
